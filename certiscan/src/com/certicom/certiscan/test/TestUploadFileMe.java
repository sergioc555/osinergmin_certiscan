...
public class TestUploadFileMe {
	
	final static String dir_files = "/home/rbullon/Sergio/proyectos/osinergmin/basePruebas/PAPEL";
	...
	public void upload() throws Exception{
		...
		//Utiles.enviarArchivoViaSFTP2(archImg, nombreArchivo, _rutaExp);
		 ...
		 TestUploadFileMe t = new TestUploadFileMe();
		 ...
		 for (File file : files){
			 ...
			 while (rs.next()){
				 ...
				 System.out.println(">>>>>>PROCESANDO ARCHIVO : " + rs.getString(1));
