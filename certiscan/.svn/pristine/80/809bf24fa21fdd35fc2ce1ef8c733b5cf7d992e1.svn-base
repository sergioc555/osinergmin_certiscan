...
@ViewScoped
public class CalidadMB extends GenericBeans implements Serializable{
	...
	public void inicia(){
		...
		try {
			...
			this.listIndicadorCalls = this.indicadorCallServices.findByCategoria(Constante.IND_CC_INTERNO);
	...
	public void eliminar(){
		...
		try {
			...
			this.listExpedienteIncidencias = this.expedienteIncidenciaServices.listarIncidenciasIndicadores(this.expSelected.getExpediente_id(), Constante.IND_CC_INTERNO, Constante.PROCESO_CI);
		} catch (Exception e) {
	...
	public void modificarEstado(){
		...
		et.setId_estado(Constante.EST_CONTROL_CALIDAD_INTERNO);
		...
		et.setId_oficina(this.usuarioLogin.getId_oficina());
			...
			this.expedienteService.updateEstadoExpedientebyId(Constante.EST_PREPARADO_PARA_CC_ASISTENTE_FEDATARIO, this.expSelected.getExpediente_id());
...
//			this.listaExpTracking = this.expedienteTrackingService.listarTrackingxExpediente(expTra.getCod_expediente());
	...
	public void agregarIncidencia(){
		...
		try {
			...
			eiB = this.expedienteIncidenciaServices.listarIncidenciasExp(this.expSelected.getExpediente_id(), this.id_indicador_call, Constante.PROCESO_CI);
			...
			ei.setProceso(Constante.PROCESO_CI);
	...
	//			}
				...
				this.listaExpedientes = this.expedienteService.consultaCalidadExpediente(expedienteFilter);
	...
	public void cargarDatos(Expediente exp) {
		...
		try {
			...
			this.expSelected.setId_estado(Constante.EST_CONTROL_CALIDAD_INTERNO);
