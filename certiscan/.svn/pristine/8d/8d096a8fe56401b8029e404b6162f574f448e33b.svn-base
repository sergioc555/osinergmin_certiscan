...
@ManagedBean(name="reProcesoMB")
@ViewScoped
public class reProcesoMB extends GenericBeans implements Serializable{
	...
	public void modificarEstado(){
		...
		et.setId_oficina(this.usuarioLogin.getId_oficina());
				...
				this.expedienteService.updateEstadoExpedientebyId(Constante.EST_SUBSANADO_ENVIADO_A_ASISTENTE_DE_FEDATARIO, this.expSelected.getExpediente_id());
				et.setId_estado(Constante.EST_SUBSANADO_ENVIADO_A_ASISTENTE_DE_FEDATARIO);
...
//			this.listaExpTracking = this.expedienteTrackingService.listarTrackingxExpediente(expTra.getCod_expediente());
	...
	//			}
				...
				this.listaExpedientes = this.expedienteService.consultaReprocesoExpediente(expedienteFilter);
	...
	public void cargarDatos(Expediente exp) {
		...
		try {
			...
			this.expSelected.setId_estado(Constante.EST_SUBSANADO_ENVIADO_A_ASISTENTE_DE_FEDATARIO);
